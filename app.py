...
@app.route('/DeleteAllParticipants', methods=['GET', 'POST'])
...
@app.route('/updateDBProfile', methods=['GET', 'POST'])
def updateDBProfile():
    answer=""
    try:
        requestData=h_func.convertData(request.data)
...
@app.route('/getDBProfileDetails', methods=['GET', 'POST'])
...
@app.route('/getDBProfilesPublic', methods=['GET', 'POST'])
